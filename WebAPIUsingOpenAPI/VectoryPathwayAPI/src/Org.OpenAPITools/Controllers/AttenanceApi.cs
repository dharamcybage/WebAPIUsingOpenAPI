...
using Swashbuckle.Swagger.Annotations; using Swashbuckle.Swagger.Annotations; using Org.OpenAPITools.Models;
...
{ 
    ...
    /// </summary>
    [ApiController]
    public class AttenanceApiController : ControllerBase
    { 
        /// <summary>
