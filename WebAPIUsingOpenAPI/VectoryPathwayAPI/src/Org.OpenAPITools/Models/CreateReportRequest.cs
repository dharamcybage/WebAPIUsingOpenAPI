...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CreateReportRequest : IEquatable<CreateReportRequest>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public List<CreateReportRequestFilter> Filters { get; set; }

        /// <summary>
        /// Gets or Sets IsFilter
        /// </summary>
        [DataMember(Name="isFilter", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CreateReportRequest)obj);
        }

        /// <summary>
        /// Returns true if CreateReportRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateReportRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReportRequest other)
        {
            ...
            return 
                ...
                (
                    ...
                    IsFilter != null &&
                    IsFilter.Equals(other.IsFilter)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IsFilter != null)
                    hashCode = hashCode * 59 + IsFilter.GetHashCode();
                    if (Columns != null)
        ...
        public static bool operator ==(CreateReportRequest left, CreateReportRequest right)
        {
