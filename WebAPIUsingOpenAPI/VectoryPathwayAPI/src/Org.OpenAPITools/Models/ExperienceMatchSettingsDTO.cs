...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ExperienceMatchSettingsDTO : IEquatable<ExperienceMatchSettingsDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets UserLoadedMatchedExperiences
        /// </summary>
        [Required]
        [DataMember(Name="userLoadedMatchedExperiences", EmitDefaultValue=true)]
        public bool UserLoadedMatchedExperiences { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExperienceMatchSettingsDTO {\n");
            sb.Append("  PreferredTimes: ").Append(PreferredTimes).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Address: ").Append(Address).Append("\n");
            sb.Append("  UserLoadedMatchedExperiences: ").Append(UserLoadedMatchedExperiences).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ExperienceMatchSettingsDTO)obj);
        }

        /// <summary>
        /// Returns true if ExperienceMatchSettingsDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ExperienceMatchSettingsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExperienceMatchSettingsDTO other)
        {
            ...
            return 
                ...
                (
                    UserLoadedMatchedExperiences == other.UserLoadedMatchedExperiences ||
                    
                    UserLoadedMatchedExperiences.Equals(other.UserLoadedMatchedExperiences)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + UserLoadedMatchedExperiences.GetHashCode();
        ...
        public static bool operator ==(ExperienceMatchSettingsDTO left, ExperienceMatchSettingsDTO right)
        {
