...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UserCourseAttendance : IEquatable<UserCourseAttendance>
    {
        /// <summary>
        /// Gets or Sets ShiftStatus
        /// </summary>
        [Required]
        [DataMember(Name="shiftStatus", EmitDefaultValue=false)]
        ...
        public CourseAttendanceDTO Attendance { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserCourseAttendance {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UserCourseAttendance)obj);
        }

        /// <summary>
        /// Returns true if UserCourseAttendance instances are equal
        /// </summary>
        /// <param name="other">Instance of UserCourseAttendance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCourseAttendance other)
        {
            ...
            return 
                (
                    ...
                    ShiftStatus != null &&
                    ShiftStatus.Equals(other.ShiftStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (ShiftStatus != null)
                    hashCode = hashCode * 59 + ShiftStatus.GetHashCode();
                    if (Attendance != null)
        ...
        public static bool operator ==(UserCourseAttendance left, UserCourseAttendance right)
        {
